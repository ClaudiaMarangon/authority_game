...
class Constants(BaseConstants):
    name_in_url = 'practice_game_norm'
    players_per_group = 2
    num_rounds = 40
    authority_c = c(5)
    authority_rr = c(3)
    ...
    subordinate_rr = c(5)
    subordinate_c = c(7)
    computer_choices_a = ['perform the Task', 'perform the Task', 'perform the Task', 'perform the Task', 'not perform the Task']
    computer_choices_s = ['perform the Task', 'not perform the Task', 'not perform the Task', 'not perform the Task', 'not perform the Task']
